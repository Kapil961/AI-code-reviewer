...
#define ARROW_CXX_COMPILER_FLAGS " -fno-aligned-new -march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /opt/anaconda3/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_8e2pf4rqhl/croot/arrow-cpp_1742830302925/work=/usr/local/src/conda/arrow-cpp-19.0.0 -fdebug-prefix-map=/opt/anaconda3=/usr/local/src/conda-prefix -Qunused-arguments -fcolor-diagnostics  -Wall -Wno-unknown-warning-option -Wno-pass-failed "
